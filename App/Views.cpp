...
{ 
   return _T("<Dialog>")
      _T("<HorizontalLayout>")
        ...
        _T("<VerticalLayout>")
          _T("<Toolbar>")
            _T("<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System Opstning</c></f>\" />")
          _T("</Toolbar>")
          _T("<ToolbarTitlePanel name=\"titlepanel\" text=\"<f 7>System Opstning</f>\" />")
          _T("<TitleShadow />")
          _T("<WindowCanvas>")
            _T("<VerticalLayout>")
              ...
              _T("<TabFolder width=\"200\" inset=\"8 8\" >")
                _T("<TabPage text=\"Generelt\" >")
                  _T("<DialogLayout scrollbar=\"true\" >")
                    _T("<LabelPanel pos=\"0, 0, 150, 24\" text=\"S&g efter\" />")
                    ...
                    _T("<Button pos=\"100, 98, 150, 118\" name=\"ok\" text=\"Sg\" />")
                  _T("</DialogLayout>")
                _T("</TabPage>")
              _T("</TabFolder>")
              _T("<List name=\"list\">")
...
{ 
   return _T("<Dialog>")
      _T("<HorizontalLayout>")
        ...
        _T("<VerticalLayout>")
          _T("<Toolbar>")
            _T("<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System</c></f>\" />")
          _T("</Toolbar>")
          _T("<TitleShadow />")
          _T("<WindowCanvas>")
            _T("<VerticalLayout>")
              _T("<DialogLayout scrollbar=\"true\" >")
                _T("<LabelPanel pos=\"0, 0, 80, 24\" text=\"<b>&Sg efter</b>\" stretch=\"group\" />")
                _T("<SingleLineEdit pos=\"80, 2, 220, 22\" name=\"navn\" stretch=\"size_x\" />")
                _T("<Button pos=\"224, 2, 265, 22\" text=\"Sg\" name=\"ok\" stretch=\"move_x\" />")
...
{ 
   return _T("<Dialog caption=\"Search Page\" >")
      _T("<VerticalLayout>")
        _T("<ToolbarTitlePanel text=\"<f 6>Sg efter en vej.</f><p><x 10>Indtast sgekriterier og sg efter vejen.\" />")
        _T("<DialogCanvas>")
          _T("<VerticalLayout>")
            _T("<DialogLayout>")
              ...
              _T("</DropDown>")
              _T("<LabelPanel pos=\"0, 36, 60, 60\" text=\"Sg\" stretch=\"group\" />")
              _T("<SingleLineEdit pos=\"60, 38, 250, 58\" name=\"search\" text=\"\" stretch=\"size_x\" />")
              _T("<Button pos=\"260, 38, 340, 58\" name=\"ok\" text=\"&Sg\" stretch=\"move_x\" />")
